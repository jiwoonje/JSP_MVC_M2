	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (path.equals("/insertBoard.do")) {
			...
			*/
			...
			// 4. 뷰 페이지 전송 : 값을 insertBoard 완료 후 DB의 전체 레코드를 출력하는 페이지로 이동
			...
			// boardList : DB의 Board 테이블 레코드를 dto로 저장 후 ArrayList 내의 각 방에 저장된 상태
			...
			// 1. client 넘어오는 파라미터 seq 변수의 값을 읽어서 dto에 저장 후 dao 호출
